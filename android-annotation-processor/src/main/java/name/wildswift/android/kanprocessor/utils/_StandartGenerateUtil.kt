...
val recyclerHolderClass = ClassName("androidx.recyclerview.widget", "RecyclerView", "ViewHolder")
val recyclerDataObserverClass = ClassName("androidx.recyclerview.widget", "RecyclerView", "AdapterDataObserver")
